...
<body class="bg-[#030712] text-white min-h-screen selection:bg-blue-500/30">
    ...
    <main class="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-40">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="group relative <?php echo e($index == 1 ? 'animate-float' : ''); ?>">
                    ...
                    <div class="glass <?php echo e($index == 1 ? 'border-2 border-blue-500/50 bg-blue-500/5' : 'border border-gray-800'); ?> rounded-[2.5rem] p-8 h-full flex flex-col transition-all duration-500 hover:border-gray-600">
                        <div class="mb-6">
                            <h3 class="text-2xl font-black mb-1 text-white"><?php echo e($tier['name']); ?></h3>
                            <div class="flex items-center gap-2">
                                <span class="bg-white/10 px-2 py-0.5 rounded text-[10px] font-bold text-gray-400 uppercase tracking-widest"><?php echo e(number_format($tier['limit'], 0)); ?> Mensagens/mês</span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tier['savings']): ?>
                                    <span class="text-[10px] font-black text-green-400 uppercase tracking-widest"><?php echo e($tier['savings']); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="mb-8 p-5 rounded-3xl bg-white/5 border border-white/5 hover:bg-white/10 transition group/item relative">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="text-right">
                                    <div class="text-2xl font-black">R$ <?php echo e(number_format($textPlan->price ?? 0, 0)); ?></div>
                                    <div class="text-[10px] text-gray-400">R$ <?php echo e(number_format(($textPlan->price ?? 0) / $tier['limit'], 2, ',', '.')); ?>/msg</div>
                                </div>
                            </div>
                            <a href="/purchase/<?php echo e($textPlan->id ?? '#'); ?>" class="block w-full py-3 rounded-xl text-center text-xs font-black bg-white/5 hover:bg-blue-600 transition-all duration-300 border border-white/10 hover:border-blue-500">ASSINAR SÓ TEXTO</a>
                        </div>
                        ...
                        <div class="p-5 rounded-3xl bg-gradient-to-br from-purple-600/10 to-transparent border border-purple-500/20 hover:border-purple-500/50 transition shadow-2xl shadow-purple-900/10 relative">
                            ...
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="text-right">
                                    <div class="text-2xl font-black text-white">R$ <?php echo e(number_format($mediaPlan->price ?? 0, 0)); ?></div>
                                    <div class="text-[10px] text-gray-400">R$ <?php echo e(number_format(($mediaPlan->price ?? 0) / $tier['limit'], 2, ',', '.')); ?>/msg</div>
                                </div>
                            </div>
                            <a href="/purchase/<?php echo e($mediaPlan->id ?? '#'); ?>" class="block w-full py-3 rounded-xl text-center text-xs font-black bg-purple-600 hover:bg-purple-500 transition-all duration-300 shadow-lg shadow-purple-600/20">ASSINAR COM MÍDIA</a>
                        </div>
...
<?php /**PATH C:\Users\Felipe\Desktop\SaaS WhatsApp\resources\views/plans.blade.php ENDPATH**/ ?>