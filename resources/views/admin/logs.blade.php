...
@section('content')
    <div class="flex flex-col space-y-8">
        ...
        @if($queuedReason)
        <div class="bg-amber-500/10 border border-amber-500/20 p-6 rounded-[32px] flex items-center space-x-4">
            ...
            <div>
                <p class="text-sm font-bold text-white">Mensagens na Fila</p>
